"""
Energy Grid Management System - Neo4j Connection Module

This module provides connection management for Neo4j database,
including connection pooling, transaction handling, and error recovery.
"""
...
class Neo4jConnection:
    ...
    def get_relationship_type_counts(self) -> Dict[str, int]:
        """Get count of relationships per type."""
        query = """
        MATCH ()-[r]->()
        ...
        """
        results = self.execute_read(query)
        return {r["relationship_type"]: r["count"] for r in results}
